      ...
      <div ref={ref} className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-12 hidden md:grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {items.map((item, i) => (
            ...
            >
              <Card className="h-full border-border/50 hover:border-honey-200 dark:hover:border-honey-800 transition-colors">
                <CardContent className="p-6">
                  ...
                  <div className="mt-5 pt-4 border-t border-border/50 flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 rounded-full bg-gradient-to-br from-honey-300 to-honey-500 flex items-center justify-center text-white font-bold text-sm">
                        {item.name.charAt(0)}
                      </div>
                      <div>
            ...
            <AnimatePresence mode="wait" custom={direction}>
              ...
              >
                <Card className="border-border/50">
                  <CardContent className="p-6">
                    <Quote className="w-8 h-8 text-honey-300 mb-4" />
                    <div className="flex gap-0.5 mb-4">
                      {Array.from({ length: items[current].rating }).map((_, si) => (
                        <Star
                          key={si}
                          className="w-4 h-4 fill-honey-400 text-honey-400"
                        />
